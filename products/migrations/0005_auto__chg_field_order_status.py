...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.status'
        db.alter_column(u'products_order', 'status', self.gf('django.db.models.fields.CharField')(max_length=32))

    def backwards(self, orm):

        # Changing field 'Order.status'
        db.alter_column(u'products_order', 'status', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
